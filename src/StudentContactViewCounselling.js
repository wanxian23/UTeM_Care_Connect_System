...
function StudentContactView() {
    ...
    const { studentId, paId, date } = useParams();
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8080/care_connect_system/backend/api/getStudentContactCalendarDetails.php?studentId=${studentId}&selectedDate=${date}&paId=${paId}`, {
            method: "GET",
            headers: {
