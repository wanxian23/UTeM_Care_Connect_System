                                ...
                                {allData.avgTodayStudentStressLevel ? 
                                     <>
                                        <aside>
                                            ...
                                            <div>
                                                <img src={allData.avgTodayStudentMoodStoreLocation}></img>
                                                <p>{allData.avgTodayStudentMoodStatus}</p>
                                            </div>
                                        </aside>
                                        <aside>
                                            <label>Average Stress Level:</label>
                                            <p style={{backgroundColor: color, width: "60px", height: "60px" , borderRadius: "50%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>{allData.avgTodayStudentStressLevel}%</p>
                                            <p>{level}</p>
                                        </aside>  
                                     </>   
                                :
