...
function StudentInfo() {
    ...
    useEffect(() => {
        ...
        const url = `http://localhost:8080/care_connect_system/backend/api/getStatisticPa.php?studentId=${studentId}&weekOffset=${weekOffset}&monthOffset=${monthOffset}&paId=${paId}`;
