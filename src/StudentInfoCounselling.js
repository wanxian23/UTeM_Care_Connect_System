...
function StudentInfo() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8080/care_connect_system/backend/api/getStudentInfo.php?studentId=${studentId}&paId=${paId}`, {
            method: "GET",
            headers: {
...
export function SubHeader({studentId, paId}) {

    return(
        <>
            <aside className="studentInfoAsideWrapper">
                <NavLink
                    to={`/StudentInfoCounselling/${studentId}/${paId}`}
                    className={({ isActive }) =>
                ...
                <NavLink
                    to={`/StudentInfoStatisticCounselling/${studentId}/${paId}`}
                    className={({ isActive }) =>
                ...
                <NavLink
                    to={`/StudentContactHistoryCounselling/${studentId}/${paId}`}
                    className={({ isActive }) =>
