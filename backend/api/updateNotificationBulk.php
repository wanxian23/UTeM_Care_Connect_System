...
// ✅ Build type string: 's' for newStatus, 'i' for each ID, 'i' for studentId
$types = 's' . str_repeat("i", count($ids)) . 'i';

// ✅ Build params array: newStatus, then all IDs, then studentId
$params = array_merge([$newStatus], $ids, [$studentId]);
